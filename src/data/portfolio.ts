...
export const projects = [
  { id: 'urban-pulse', title: "The Urban Pulse", desc: "Analyzing city traffic patterns using 5TB of sensor data.", details: "A comprehensive data analysis project processing over 5TB of IoT sensor data from metropolitan traffic systems. Utilized Python and Pandas for cleaning, and D3.js for visualizing congestion heatmaps in real-time. Reduced prediction latency by 40%.", tech: ["Python", "Pandas", "D3.js"], type: "Data Science", color: "from-teal-400 to-emerald-500", link: "https://github.com/samriddhi/urban-pulse" },
  { id: 'neuronet', title: "NeuroNet", desc: "CNN for detecting early-stage radiology anomalies.", details: "Developed a Convolutional Neural Network architecture achieving 94% accuracy in detecting early-stage anomalies in X-ray scans. Implemented using PyTorch and TensorFlow, with a React frontend for radiologists to upload and view inference results.", tech: ["PyTorch", "TensorFlow"], type: "Machine Learning", color: "from-emerald-400 to-teal-600", link: "https://github.com/samriddhi/neuronet" },
  { id: 'ecoparser', title: "EcoParser", desc: "Real-time dashboard for environmental monitoring sensors.", details: "Full-stack IoT dashboard for monitoring air quality index (AQI) sensors. Built with Node.js MQTT broker to handle high-throughput sensor streams and a Next.js frontend for real-time visualization. Deployed on AWS.", tech: ["React", "Node.js", "AWS"], type: "Full Stack", color: "from-teal-500 to-emerald-700", link: "https://github.com/samriddhi/ecoparser" }
];
